...
function demoInfo(sample)
{
    ...
    d3.json("samples.json").then((data) => {  
        ...
        //filter based on the value of the sample (should returl 1 result 
        // in an array based on the dataset)
...
function initialize()
{
    ...
    // use d3.json to get the data
    d3.json("samples.json").then((data) => {
        let sampleNames = data.names; // made an array of just names
        ...
        // when intitialized, pass in the information from the first sample
